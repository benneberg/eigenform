...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-substrate-950 text-substrate-200 overflow-hidden font-sans border-[6px] md:border-[12px] border-[#151515] relative flex-col md:flex-row">
